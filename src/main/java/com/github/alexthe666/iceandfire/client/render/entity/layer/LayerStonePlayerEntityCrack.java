...
public class LayerStonePlayerEntityCrack<T extends EntityLivingBase> implements LayerRenderer<T> {
	...
	public LayerStonePlayerEntityCrack(RenderLivingBase<T> renderer) {
		this.renderer = renderer;
	}

	@Override
	public void doRenderLayer(T entitylivingbaseIn, float f, float f1, float i, float f2, float f3, float f4,
			float f5) {
